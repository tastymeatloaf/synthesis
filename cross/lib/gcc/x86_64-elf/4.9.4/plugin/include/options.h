...
enum opt_code
{
  ...
  OPT_mbmi = 1097,                           /* -mbmi */
  OPT_mbmi2 = 1098,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1099,                  /* -mbranch-cost= */
  OPT_mcld = 1100,                           /* -mcld */
  OPT_mcmodel_ = 1101,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1102, */                    /* -mcpu= */
  OPT_mcrc32 = 1103,                         /* -mcrc32 */
  OPT_mcx16 = 1104,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1105,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1106,            /* -mdump-tune-features */
  OPT_mf16c = 1107,                          /* -mf16c */
  OPT_mfancy_math_387 = 1108,                /* -mfancy-math-387 */
  OPT_mfentry = 1109,                        /* -mfentry */
  OPT_mfma = 1110,                           /* -mfma */
  OPT_mfma4 = 1111,                          /* -mfma4 */
  OPT_mforce_drap = 1112,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1113,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1114,                       /* -mfpmath= */
  OPT_mfsgsbase = 1115,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1116, */              /* -mfused-madd */
  OPT_mfxsr = 1117,                          /* -mfxsr */
  OPT_mhard_float = 1118,                    /* -mhard-float */
  OPT_mhle = 1119,                           /* -mhle */
  OPT_mieee_fp = 1120,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1121,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1122,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1123,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1124, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1125,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1126,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1127,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1128,                /* -mlong-double-80 */
  OPT_mlwp = 1129,                           /* -mlwp */
  OPT_mlzcnt = 1130,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1131,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1132,              /* -mmemset-strategy= */
  OPT_mmmx = 1133,                           /* -mmmx */
  OPT_mmovbe = 1134,                         /* -mmovbe */
  OPT_mms_bitfields = 1135,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1136,            /* -mno-align-stringops */
  OPT_mno_default = 1137,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1138,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1139,                  /* -mno-push-args */
  OPT_mno_red_zone = 1140,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1141,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1142,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1143,                          /* -mpc32 */
  OPT_mpc64 = 1144,                          /* -mpc64 */
  OPT_mpc80 = 1145,                          /* -mpc80 */
  OPT_mpclmul = 1146,                        /* -mpclmul */
  OPT_mpopcnt = 1147,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1148,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1149,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1150,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1151,                        /* -mprfchw */
  OPT_mpush_args = 1152,                     /* -mpush-args */
  OPT_mrdrnd = 1153,                         /* -mrdrnd */
  OPT_mrdseed = 1154,                        /* -mrdseed */
  OPT_mrecip = 1155,                         /* -mrecip */
  OPT_mrecip_ = 1156,                        /* -mrecip= */
  OPT_mred_zone = 1157,                      /* -mred-zone */
  OPT_mregparm_ = 1158,                      /* -mregparm= */
  OPT_mrtd = 1159,                           /* -mrtd */
  OPT_mrtm = 1160,                           /* -mrtm */
  OPT_msahf = 1161,                          /* -msahf */
  OPT_msha = 1162,                           /* -msha */
  OPT_msoft_float = 1163,                    /* -msoft-float */
  OPT_msse = 1164,                           /* -msse */
  OPT_msse2 = 1165,                          /* -msse2 */
  OPT_msse2avx = 1166,                       /* -msse2avx */
  OPT_msse3 = 1167,                          /* -msse3 */
  OPT_msse4 = 1168,                          /* -msse4 */
  OPT_msse4_1 = 1169,                        /* -msse4.1 */
  OPT_msse4_2 = 1170,                        /* -msse4.2 */
  OPT_msse4a = 1171,                         /* -msse4a */
  /* OPT_msse5 = 1172, */                    /* -msse5 */
  OPT_msseregparm = 1173,                    /* -msseregparm */
  OPT_mssse3 = 1174,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1175,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1176,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1177,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1178,            /* -mstringop-strategy= */
  OPT_mtbm = 1179,                           /* -mtbm */
  OPT_mtls_dialect_ = 1180,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1181,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1182,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1183,                         /* -mtune= */
  OPT_mveclibabi_ = 1184,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1185,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1186,                    /* -mvzeroupper */
  OPT_mx32 = 1187,                           /* -mx32 */
  OPT_mxop = 1188,                           /* -mxop */
  OPT_mxsave = 1189,                         /* -mxsave */
  OPT_mxsaveopt = 1190,                      /* -mxsaveopt */
  OPT_n = 1191,                              /* -n */
  ...
  OPT_std_gnu__1y = 1261,                    /* -std=gnu++1y */
